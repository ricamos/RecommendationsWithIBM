...
![alt text](https://github.com/ricamos/RecommendationsWithIBM/blob/master/img/new_in_the_community.png)
...
Recommendations_with_IBM.ipynb -  In this notebook, you will be putting your recommendation skills to use on real data from the IBM Watson Studio platform.
...
Matrix factorization fo Recommendation
Matrix Factorization with SVD
Collaborative filtering using FunkSVD 
Content based and ranked based recommendations
